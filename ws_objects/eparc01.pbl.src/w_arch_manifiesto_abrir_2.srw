$PBExportHeader$w_arch_manifiesto_abrir_2.srw
forward
global type w_arch_manifiesto_abrir_2 from wa_response
end type
type cb_buscar from uo_cbother within w_arch_manifiesto_abrir_2
end type
end forward
...
global w_arch_manifiesto_abrir_2 w_arch_manifiesto_abrir_2
...
on w_arch_manifiesto_abrir_2.create
int iCurrent
call super::create
...
on w_arch_manifiesto_abrir_2.destroy
call super::destroy
...
type dw_list from wa_response`dw_list within w_arch_manifiesto_abrir_2
int X=37
int Y=132
int Width=1888
int Height=768
int TabOrder=20
string DataObject="d_arch_manifiesto_abrir_2"
end type
...
type dw_1 from wa_response`dw_1 within w_arch_manifiesto_abrir_2
int X=46
int Y=904
int Width=306
int Height=136
...
type cb_cancelar from wa_response`cb_cancelar within w_arch_manifiesto_abrir_2
int X=1225
int Y=924
int TabOrder=40
end type
...
type cb_aceptar from wa_response`cb_aceptar within w_arch_manifiesto_abrir_2
int X=855
int Y=924
int TabOrder=30
end type
