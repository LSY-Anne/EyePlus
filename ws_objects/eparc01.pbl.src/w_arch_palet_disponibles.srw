$PBExportHeader$w_arch_palet_disponibles.srw
forward
global type w_arch_palet_disponibles from wa_response
end type
type cbx_1 from checkbox within w_arch_palet_disponibles
end type
end forward
...
global w_arch_palet_disponibles w_arch_palet_disponibles

type variables
String is_mess
end variables

on w_arch_palet_disponibles.create
int iCurrent
call super::create
...
on w_arch_palet_disponibles.destroy
call super::destroy
destroy(this.cbx_1)
end on

event open;call super::open;string ls_tipo,ls_punto
...
dw_list.Retrieve( gs_codtem,ls_tipo,ls_punto )
...
type dw_list from wa_response`dw_list within w_arch_palet_disponibles
int X=37
int Y=32
int Width=2789
int Height=780
...
type dw_1 from wa_response`dw_1 within w_arch_palet_disponibles
int X=1481
int Y=860
int Width=306
int Height=136
...
type cb_cancelar from wa_response`cb_cancelar within w_arch_palet_disponibles
int X=2482
int Y=840
end type

type cb_aceptar from wa_response`cb_aceptar within w_arch_palet_disponibles
int X=2103
int Y=840
end type
