$PBExportHeader$w_arch_palet_disponibles_epsa.srw
forward
global type w_arch_palet_disponibles_epsa from wa_response
end type
type cbx_1 from checkbox within w_arch_palet_disponibles_epsa
end type
end forward
...
global w_arch_palet_disponibles_epsa w_arch_palet_disponibles_epsa

type variables
String is_mess
end variables

on w_arch_palet_disponibles_epsa.create
int iCurrent
call super::create
...
on w_arch_palet_disponibles_epsa.destroy
call super::destroy
destroy(this.cbx_1)
end on
...
type dw_list from wa_response`dw_list within w_arch_palet_disponibles_epsa
int X=37
int Y=32
int Width=2789
int Height=780
string DataObject="d_arch_palet_disponibles"
end type
...
type dw_1 from wa_response`dw_1 within w_arch_palet_disponibles_epsa
int X=1481
int Y=860
int Width=306
int Height=136
boolean Visible=false
string DataObject="d_rpt_pallet_disponibles_epsa"
end type

type cb_cancelar from wa_response`cb_cancelar within w_arch_palet_disponibles_epsa
int X=2482
int Y=840
end type

type cb_aceptar from wa_response`cb_aceptar within w_arch_palet_disponibles_epsa
int X=2103
int Y=840
end type
