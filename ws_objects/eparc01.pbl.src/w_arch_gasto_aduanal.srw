$PBExportHeader$w_arch_gasto_aduanal.srw
forward
global type w_arch_gasto_aduanal from wa_response
end type
type p_ind from picture within w_arch_gasto_aduanal
end type
type dw_prn from datawindow within w_arch_gasto_aduanal
end type
type cb_imprimir from uo_cbother within w_arch_gasto_aduanal
end type
type cb_guardar from commandbutton within w_arch_gasto_aduanal
end type
end forward
...
global w_arch_gasto_aduanal w_arch_gasto_aduanal
...
MessageBox( Title, 'Importe de Gasto Aduanal guardado correctamente.' )
dw_1.setfocus()
...
dw_1.DataObject = 'd_arch_gasto_aduanal'
dw_1.Reset( )
...
String	ls_doc
s_parm	lstr_parm
w_arch_gasto_aduanal	lw_win

SetNull( Message.PowerObjectParm )
SetNull(ld_null)

OpenWithParm( w_arch_documento_abrir, 'MAN' )
...
If f_trim(lstr_parm.s_cad[1])  = '' Then Return 0
	...
	if isnull(lw_win.dw_1.object.d_embarque_man[1]) then
		lw_win.dw_1.object.d_embarque_man[1] = ld_null
	end if
	
	if (isnull(lw_win.dw_1.object.mercado[1])) or ((lw_win.dw_1.object.mercado[1]) = '') then
		lw_win.dw_1.object.mercado[1] = 'S/d'
	end if
	
	if (isnull(lw_win.dw_1.object.c_numfac_man[1])) or ((lw_win.dw_1.object.c_numfac_man[1]) = '') then
		lw_win.dw_1.object.c_numfac_man[1] = 'S/d'
	end if
	
	if (isnull(lw_win.dw_1.object.embarcador[1])) or ((lw_win.dw_1.object.embarcador[1]) = '') then
		lw_win.dw_1.object.embarcador[1] = 'S/d'
	end if
	
	if (isnull(lw_win.dw_1.object.n_totbul_man[1])) or ((lw_win.dw_1.object.n_totbul_man[1]) < 0) then
		lw_win.dw_1.object.n_totbul_man[1] = 0
	end if
	
	if (isnull(lw_win.dw_1.object.distribuidor[1])) or ((lw_win.dw_1.object.distribuidor[1]) = '') then
		lw_win.dw_1.object.distribuidor[1] = 'S/d'
	end if
	
	if (isnull(lw_win.dw_1.object.n_importe_man[1])) or ((lw_win.dw_1.object.n_importe_man[1]) < 0) then
		lw_win.dw_1.object.n_importe_man[1] = 0
	end if
	
	if (isnull(lw_win.dw_1.object.v_nombre_aga[1])) or ((lw_win.dw_1.object.v_nombre_aga[1]) = '') then
		lw_win.dw_1.object.v_nombre_aga[1] = 'S/d'
	end if
	
	if (isnull(lw_win.dw_1.object.v_codpos_aga[1])) or ((lw_win.dw_1.object.v_codpos_aga[1]) = '') then
		lw_win.dw_1.object.v_codpos_aga[1] = 'S/d'
	end if
	
	if (isnull(lw_win.dw_1.object.v_direcc_aga[1])) or ((lw_win.dw_1.object.v_direcc_aga[1]) = '') then
		lw_win.dw_1.object.v_direcc_aga[1] = 'S/d'
	end if
	
	if (isnull(lw_win.dw_1.object.v_telef1_aga[1])) or ((lw_win.dw_1.object.v_telef1_aga[1]) = '') then
		lw_win.dw_1.object.v_telef1_aga[1] = 'S/d'
	end if
	
	if (isnull(lw_win.dw_1.object.v_ciudad_aga[1])) or ((lw_win.dw_1.object.v_ciudad_aga[1]) = '') then
		lw_win.dw_1.object.v_ciudad_aga[1] = 'S/d'
	end if
	
	if (isnull(lw_win.dw_1.object.c_rfc_aga[1])) or ((lw_win.dw_1.object.c_rfc_aga[1]) = '') then
		lw_win.dw_1.object.c_rfc_aga[1] = 'S/d'
	end if
	
	if (isnull(lw_win.dw_1.object.n_gastoaduanal_man[1])) or ((lw_win.dw_1.object.n_gastoaduanal_man[1]) < 0) then
		lw_win.dw_1.object.n_gastoaduanal_man[1] = 0
	end if
...
public subroutine wf_configurardoc ();This.Title = 'Gasto Aduanal'
...
If ls_cod = '' Then
	...
	If Not ls_parm = '' Then
		...
		if isnull(ls_cp) or (ls_cp = '') then
			...
			dw_1.Object.v_cospos_aga[1] = ls_cp
		end if
...
on w_arch_gasto_aduanal.create
int iCurrent
call super::create
...
on w_arch_gasto_aduanal.destroy
call super::destroy
...
cb_imprimir.x =cb_guardar.x  + 700
cb_cancelar.x =cb_imprimir.x + 700
...
type dw_list from wa_response`dw_list within w_arch_gasto_aduanal
int X=224
int Y=676
int Width=78
int Height=104
...
type dw_1 from wa_response`dw_1 within w_arch_gasto_aduanal
event key pbm_dwnkey
int X=14
int Y=4
int Width=3182
int Height=672
string DataObject="d_arch_gasto_aduanal"
end type
...
type cb_cancelar from wa_response`cb_cancelar within w_arch_gasto_aduanal
int X=1838
int Y=728
int Width=549
int Height=80
...
type cb_aceptar from wa_response`cb_aceptar within w_arch_gasto_aduanal
int X=155
int Y=676
int Width=50
int Height=100
