$PBExportHeader$w_arch_mano_obra_list.srw
forward
global type w_arch_mano_obra_list from wa_proc
end type
end forward
...
global w_arch_mano_obra_list w_arch_mano_obra_list

type variables
w_arch_mano_obra_edit  iw_edit
end variables
...
on w_arch_mano_obra_list.create
call super::create
end on

on w_arch_mano_obra_list.destroy
call super::destroy
...
string DataObject="d_arch_mano_obra_list"
end type
...
type dw_prn from wa_proc`dw_prn within w_arch_mano_obra_list
int TabOrder=0
string DataObject="d_rpt_mano_obra"
end type

type cb_cerrar from wa_proc`cb_cerrar within w_arch_mano_obra_list
int TabOrder=70
end type

type cb_autorizar from wa_proc`cb_autorizar within w_arch_mano_obra_list
int TabOrder=60
end type
