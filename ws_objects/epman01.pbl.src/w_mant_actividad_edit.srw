$PBExportHeader$w_mant_actividad_edit.srw
forward
global type w_mant_actividad_edit from wa_mant_edit
end type
end forward
...
global w_mant_actividad_edit w_mant_actividad_edit
...
dw_1.AcceptText( )
ls_codigo = f_trim( dw_1.Object.c_codigo_act[ 1])
...
/* Descripcion */
if f_trim( dw_1.Object.v_nombre_act[ 1])= '' Then
...
on w_mant_actividad_edit.create
call super::create
end on

on w_mant_actividad_edit.destroy
call super::destroy
end on

type dw_1 from wa_mant_edit`dw_1 within w_mant_actividad_edit
int X=0
int Y=0
int Width=1760
int Height=280
string DataObject="d_mant_actividad_edit"
end type

type cb_cancelar from wa_mant_edit`cb_cancelar within w_mant_actividad_edit
int X=1385
int Y=292
end type

type cb_aceptar from wa_mant_edit`cb_aceptar within w_mant_actividad_edit
int X=1010
int Y=292
end type
