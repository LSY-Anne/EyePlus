$PBExportHeader$w_mant_menu_edit.srw
forward
global type w_mant_menu_edit from wa_mant_edit
end type
end forward
...
global w_mant_menu_edit w_mant_menu_edit
...
dw_1.AcceptText( )
ls_codigo = f_trim( dw_1.Object.c_codigo_mnu[ 1])
...
/* Descripcion */
if f_trim( dw_1.Object.v_nombre_mnu[ 1])= '' Then
...
ls_acol[] = { 'c_codigo_mnu', 'v_nombre_mnu' }
...
on w_mant_menu_edit.create
call super::create
end on

on w_mant_menu_edit.destroy
call super::destroy
end on

type dw_1 from wa_mant_edit`dw_1 within w_mant_menu_edit
int X=0
int Y=0
int Width=1595
int Height=280
string DataObject="d_mant_menu_edit"
end type

type cb_cancelar from wa_mant_edit`cb_cancelar within w_mant_menu_edit
int X=1193
int Y=304
end type

type cb_aceptar from wa_mant_edit`cb_aceptar within w_mant_menu_edit
int X=818
int Y=304
end type
