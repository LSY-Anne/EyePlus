$PBExportHeader$w_rpt_varios_04.srw
$PBExportComments$por cultivo
forward
global type w_rpt_varios_04 from wa_response
end type
type p_1 from picture within w_rpt_varios_04
end type
type st_mess from statictext within w_rpt_varios_04
end type
type em_ini from uo_editmask within w_rpt_varios_04
end type
type cb_ini from uo_cbdate within w_rpt_varios_04
end type
type st_2 from statictext within w_rpt_varios_04
end type
type em_fin from uo_editmask within w_rpt_varios_04
end type
type cb_fin from uo_cbdate within w_rpt_varios_04
end type
type st_1 from statictext within w_rpt_varios_04
end type
end forward
...
global w_rpt_varios_04 w_rpt_varios_04
...
type dw_list from wa_response`dw_list within w_rpt_varios_04
int X=59
int Y=404
int Width=155
int Height=96
...
type dw_1 from wa_response`dw_1 within w_rpt_varios_04
int X=219
int Y=184
int Width=1193
int Height=96
...
type cb_cancelar from wa_response`cb_cancelar within w_rpt_varios_04
int X=1061
int Y=440
int TabOrder=50
end type

type cb_aceptar from wa_response`cb_aceptar within w_rpt_varios_04
int X=681
int Y=440
int TabOrder=40
...
ElseIf is_rpt = 'REN' Then
	ldw_1.Retrieve( gs_codtem, f_StringToDate( em_ini.Text ), f_StringToDate( em_fin.Text ), ls_cod, '%' )
Else
