$PBExportHeader$w_rpt_acumulados_distribuidor.srw
forward
global type w_rpt_acumulados_distribuidor from wa_response
end type
type p_1 from picture within w_rpt_acumulados_distribuidor
end type
type st_mess from statictext within w_rpt_acumulados_distribuidor
end type
type em_ini from uo_editmask within w_rpt_acumulados_distribuidor
end type
type cb_5 from uo_cbdate within w_rpt_acumulados_distribuidor
end type
type st_2 from statictext within w_rpt_acumulados_distribuidor
end type
type em_fin from uo_editmask within w_rpt_acumulados_distribuidor
end type
type cb_fin from uo_cbdate within w_rpt_acumulados_distribuidor
end type
type st_1 from statictext within w_rpt_acumulados_distribuidor
end type
type sle_1 from singlelineedit within w_rpt_acumulados_distribuidor
end type
type sle_2 from singlelineedit within w_rpt_acumulados_distribuidor
end type
type sle_3 from singlelineedit within w_rpt_acumulados_distribuidor
end type
type sle_4 from singlelineedit within w_rpt_acumulados_distribuidor
end type
type cb_pro1 from commandbutton within w_rpt_acumulados_distribuidor
end type
type cb_pro2 from commandbutton within w_rpt_acumulados_distribuidor
end type
type sle_cul1 from singlelineedit within w_rpt_acumulados_distribuidor
end type
type sle_cul2 from singlelineedit within w_rpt_acumulados_distribuidor
end type
type st_cul from statictext within w_rpt_acumulados_distribuidor
end type
type cb_procul1 from commandbutton within w_rpt_acumulados_distribuidor
end type
type cb_procul2 from commandbutton within w_rpt_acumulados_distribuidor
end type
type sle_nomcul1 from singlelineedit within w_rpt_acumulados_distribuidor
end type
type sle_nomcul2 from singlelineedit within w_rpt_acumulados_distribuidor
end type
type dw_2 from datawindow within w_rpt_acumulados_distribuidor
end type
type st_3 from statictext within w_rpt_acumulados_distribuidor
end type
type st_4 from statictext within w_rpt_acumulados_distribuidor
end type
type st_5 from statictext within w_rpt_acumulados_distribuidor
end type
type st_cul2 from statictext within w_rpt_acumulados_distribuidor
end type
end forward
...
global w_rpt_acumulados_distribuidor w_rpt_acumulados_distribuidor
...
//Choose Case is_rpt
	//Case 'ACT'
		Title = 'Acumulado General por Distribuidor'	
	//End Choose
...
on w_rpt_acumulados_distribuidor.destroy
call super::destroy
destroy(this.p_1)
...
type dw_list from wa_response`dw_list within w_rpt_acumulados_distribuidor
int X=5
int Y=124
int Width=73
int Height=76
...
type dw_1 from wa_response`dw_1 within w_rpt_acumulados_distribuidor
int X=5
int Y=208
int Width=73
int Height=80
...
type cb_cancelar from wa_response`cb_cancelar within w_rpt_acumulados_distribuidor
int X=727
int Y=960
int TabOrder=110
end type

type cb_aceptar from wa_response`cb_aceptar within w_rpt_acumulados_distribuidor
int X=357
int Y=960
int TabOrder=100
...
End if
		...
		dw_list.DataObject = 'd_rpt_acumulado_distribuidor'	
